...
import './Heart.css'; // Import the CSS file for styling
  ...
  return (
    <>
      <div className='heart-container'>
        ...
        <p>You have 0 /150 items saved</p>
      </div>
      <div className='text'>
        <span>You have no saved items.</span>
        <p>Start to add your favourites by clicking the little heart next to items <br/>we'll sync these across all your devices.</p>
      </div>
